...
const specPath = resolve(root, "openapi/control-plane.openapi.json");
const typePath = resolve(root, "src/control-plane.openapi.ts");
...
if (process.argv.includes("--check")) {
  ...
  await writeFile(specPath, document);
