...
const entrySource = `import { definePresentation } from "@unframe/unframe-authoring";
...
const themeSource = `import { defineTheme } from "@unframe/unframe-authoring";
export default defineTheme({ id: "theme", tokens: {}, namedStyles: {} });`;

const extraThemeSource = `import { defineTheme } from "@unframe/unframe-authoring";
export default defineTheme({ id: "theme-z", tokens: {}, namedStyles: {} });`;

const manifestSource = `import { defineComponentManifest } from "@unframe/unframe-authoring";
...
const extraManifestSource = `import { defineComponentManifest } from "@unframe/unframe-authoring";
