...
const blogModules = import.meta.glob("/src/content/blog/*.mdx", { eager: true }) as Record<string, ContentFile>;
const docsModules = import.meta.glob("/src/content/docs/*.mdx", { eager: true }) as Record<string, ContentFile>;
